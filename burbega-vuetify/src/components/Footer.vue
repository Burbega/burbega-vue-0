  ...
  <v-footer dark height="auto">
    <v-card flat tile class="indigo lighten-1 white--text text-xs-center">
      ...
      <v-card-text class="white--text pt-0">
        ...
        Morbi vehicula lacinia malesuada. Nulla placerat augue vel ipsum ultrices,
        cursus iaculis dui sollicitudin. Vestibulum eu ipsum vel diam elementum tempor
      ...
      <v-card-text class="white--text">
        &copy;2019 —
        <strong>Vuetify - Rodrigo Mesquita</strong>
      </v-card-text>
    </v-card>
  </v-footer>
</template>
...
export default {
  data: () => ({
    icons: ["gamepad", "android", "4k", "airplay", "email"]
  })
};
</script>